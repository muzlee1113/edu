...
import { ListItem, Badge, withBadge, Icon } from 'react-native-elements'
                            ...
                            {row.map((seat, j) => {
                                ...
                                return seat ?
                                    (<><TouchableOpacity
                                        ...
                                        onLongPress={() => {
                                            this.props.longTouchEventHandler(seat.studentId)
                                        }}>
                                            
                                        <Text style={{ textAlign: "center", paddingVertical: seatPadding, fontSize: fontSize, overflow: 'hidden' }}>
                                            {seat.studentName}
                                        </Text>
                                        {this.props.inClass?(this.props.renderBadge(seat.studentId)):(<></>)}
                                    </TouchableOpacity>
